...
export class Migrations1765361699205 implements MigrationInterface {
    name = 'Migrations1765361699205'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "trip_destinations_destination" ADD CONSTRAINT "FK_d1c8914cc8dd1966c2e98fddb5b" FOREIGN KEY ("destinationId") REFERENCES "destination"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
